(function () {
  ...
  document.addEventListener("click", event => {const button=event.target.closest('[data-cohort-action]');if(button)window.CAGE_OPS.openCohort(button.dataset.cohortId,button.dataset.cohortAction,records).catch(e=>showToast(e.message));});
